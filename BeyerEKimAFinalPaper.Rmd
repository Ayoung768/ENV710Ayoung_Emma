...
```{r plot 3, message=FALSE, echo=FALSE, warning=FALSE,fig.align="center", fig.height=4, out.width="70%", include=T, fig.cap="\\label{fig:figs} The number of strandings for each age class of bottlenose dolphin. Strandings from states with active offshore wind projects are labeled in blue (1) and strandings from the other states are labeled in red (0)."}
...
```{r plot 4, message=FALSE, echo=FALSE, warning=FALSE,fig.align="center", fig.height=4, out.width="70%", include=T, fig.cap="\\label{fig:figs} The number of strandings for each sex. Strandings from states with active offshore wind projects are labeled in blue (1) and strandings from the other states are labeled in red (0)."}
