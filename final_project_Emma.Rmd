...
# use to find the sample mean of length in states with and without offshore wind
diff_length <- lm(Length ~ turbine_presence, data = cleaned_strandings_test)
...
#finding the mean of agb within VA
